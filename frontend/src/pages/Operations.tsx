            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                  ...
                  />
                  <OpsMetricCard
                    label={overview.database_label || t('ops.turso')}
                    value={`${overview.turso.usage_percent.toFixed(1)}%`}
                    sub={t('ops.dbConn', { open: overview.turso.open, max: overview.turso.max_open || '∞' })}
                    icon={<Database className="size-5" />}
                    tone={overview.turso.healthy ? getPercentTone(overview.turso.usage_percent, 75, 90) : 'danger'}
                    t={t}
                  />
                  <OpsMetricCard
